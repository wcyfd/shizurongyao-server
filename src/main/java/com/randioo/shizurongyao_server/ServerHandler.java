...
import com.randioo.shizurongyao_server.protocol.ClientMessage.CSMessage;
import com.randioo.shizurongyao_server.util.Write2File;
...
public class ServerHandler extends IoHandlerAdapter {
	...
	private String getMessage(Object message, IoSession session) {
		...
		sb.append(TimeUtils.getDetailTimeStr()).append(" [roleId:").append(roleId).append(",account:").append(roleAccount)
				.append(",name:").append(roleName).append(address).append("] ").append(message);
